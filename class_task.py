...
class CountVectorizer:
    ...
    """
    This class makes count-matrix and bag of words from your corpus (text)
    """
...
class TfIdfTransformer:
    ...
    """
    This class makes tf-matrix, idf-matrix, tf-idf-matrix from count-matrix
    """
...
class TfIdfVectorizer(CountVectorizer):
    ...
    """
    This class combines methods of last two classes
    and return tf-idf-matrix from count-matrix
    """
